...
export const BIAS_MODES: readonly string[] = Object.freeze([
  /* 0 => */ 'BiasModeDisabled', // Ovlivneni vypnuto
...
/**
 * Nazev klice pro nastaveni data a casu stridace
 */
export const KEY_DATE_TIME = 'DateTime';
...
/**
 * Pozadavek na nastaveni aktualni casu
 */
export const REGISTRY_RTC_NOW = 'now';
...
export const MANUAL_MODES: readonly string[] = Object.freeze([
  ...
  /* 2 => */ /* 'ManualModeForceDischarge' */ // Nucene vybijeni - prozatim vyhozeno
]);
...
/**
 * Data "chytreho" nabijeni
 */
export type ChargingData = ChargingType[];

/**
 * Typ pro datum a cas "chytreho" nabijeni
 */
...
export type RealTimeData = {
  ...
  RadiatorTemperatureThreshold?: Measurement;
  RunMode?:                      Measurement;
