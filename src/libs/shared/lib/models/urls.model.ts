 ...
 * @copyright  Ing. Petr Jajtner 2020
 */
import { isDevMode } from '@angular/core';
import { isObject, isString } from './utils.model';
 ...
 * URL slovniku
 */
export const JSON_DICTIONARY = isDevMode() ? 'assets/dictionary.json' : `assets/dictionary.{build}.json`;
...
/**
 * URL zmeny hodiny manualniho spousteni nabijeni
 */
export const API_MANUAL_CHARGE = 'charge';
